...
4. **Detects** specific outdated content (not general improvements)
5. **Posts** targeted update suggestions as PR comments

> **Focus on Drift:** The system specifically looks for content that has become outdated due to code changes, rather than suggesting general improvements or additions.
...
analysis-scope: 'medium'  # narrow, medium, wide, aggressive
...
Control how broadly the system analyzes for documentation that might need updates:

- **`narrow`**: Conservative analysis
  - Only docs with direct relationships to changed code
  - Fewer false positives, but might miss some relevant docs
  - Best for: Large repos where precision is more important than recall

- **`medium`** (default): Balanced analysis  
  - Docs with clear relationships + some indirect relationships
  - Good balance of precision and recall
  - Best for: Most projects

- **`wide`**: Comprehensive analysis
  - Includes path-based matching and broader pattern recognition
  - Casts a wider net to catch more potential issues
  - Best for: Projects where it's critical not to miss doc updates

- **`aggressive`**: Exhaustive analysis
  - Maximum candidate inclusion with weak relationship thresholds
  - High recall but more false positives to review
  - Best for: Critical documentation or compliance-heavy projects
